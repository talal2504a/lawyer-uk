...
<head>
    ...
    <title>LegalConnect Pakistan | Find & Book Verified Lawyers Online — Lahore, Karachi, Islamabad</title>
    <meta name="description" content="Find and book verified, experienced lawyers in Pakistan. Criminal, family, corporate & property law advocates across Lahore, Karachi and Islamabad. Book consultations online with LegalConnect Pakistan.">
    <meta name="keywords" content="lawyers in Pakistan, find a lawyer Pakistan, book lawyer online, advocate Lahore, advocate Karachi, criminal lawyer Pakistan, family lawyer, corporate lawyer Islamabad, legal services Pakistan, online lawyer booking">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="https://lawyeruk.kesug.com/">
    ...
    <meta property="og:site_name" content="LegalConnect Pakistan">
    <meta property="og:title" content="LegalConnect Pakistan | Find & Book Verified Lawyers Online">
    <meta property="og:description" content="Connecting Pakistan to expert legal council. Find trusted, verified advocates across all major cities and book consultations online.">
    <meta property="og:url" content="https://lawyeruk.kesug.com/">
    <!-- Twitter -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="LegalConnect Pakistan | Find & Book Verified Lawyers Online">
    <meta name="twitter:description" content="Find trusted, verified advocates across all major cities of Pakistan. Book consultations online.">
    <!-- Structured Data -->
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "LegalService",
      "name": "LegalConnect Pakistan",
      "url": "https://lawyeruk.kesug.com/",
      "description": "Online platform to find and book verified lawyers and advocates across Pakistan.",
      "areaServed": ["Lahore", "Karachi", "Islamabad", "Pakistan"],
      "serviceType": ["Criminal Law", "Family Law", "Corporate Law", "Property Law", "Civil Law"],
...
<link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined" rel="stylesheet" />
    ...
    @include('components.hero')
       ...
       <!-- SPECIALIZATIONS SECTION INCLUDED HERE -->
    @include('components.specializations')
    <!-- 5. TOP-RATED LAWYERS SECTION -->
        @include('components.lawyers')
        
        <!-- 6. TESTIMONIALS (VOICES OF TRUST) SECTION -->
        @include('components.testimonials')

        <!-- 6.5 JOIN AS A LAWYER CTA SECTION (MISSING ONE ADDED HERE) -->
        @include('components.join-lawyer')
       </main>
...
<!-- Include the Slide-over Drawer Component Layout -->
        ...
        if (form) {
            form.onsubmit = function(e) {
                ...
                .then(data => {
                    ...
                    if (data.errors) {
                        msg.textContent = '❌ ' + (data.errors.email || 'Invalid credentials');
